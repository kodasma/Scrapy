...
class AmazonSpiderSpider(scrapy.Spider):
    ...
    page_number = 2
    start_urls = [
        'https://www.amazon.com/s?rh=n%3A18145289011&page=1&qid=1586280480&ref=lp_18145289011_pg_2'
    ]
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.amazon.com/s?rh=n%3A18145289011&page=' + str(AmazonSpiderSpider.page_number) + '&qid=1586280480&ref=lp_18145289011_pg_2'
